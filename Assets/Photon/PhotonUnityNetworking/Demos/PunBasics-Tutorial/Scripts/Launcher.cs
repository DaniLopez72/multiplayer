	...
	public class Launcher : MonoBehaviourPunCallbacks
    {
		...
		public override void OnJoinedRoom()
		{
			...
			if (PhotonNetwork.CurrentRoom.PlayerCount == 1)
			{
				...
				// #Critical
				// Load the Room Level. 
				PhotonNetwork.LoadLevel("PunBasics-Room for 4");
		...
		string characterSelected = "Character_001";
        ...
        private void Start()
        {
			...
			{
				characterSelected = PlayerPrefs.GetString("Skin");
			}
			SetSkin(characterSelected);
        }
        public void SelectCharacter(string characterId)
		{
			if (characterSelected!= characterId)
			{
				SetSkin(characterId);
			}
